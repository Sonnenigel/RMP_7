...
public class WoolAdapter extends
        RecyclerView.Adapter<WoolAdapter.ViewHolder>{
    private final LayoutInflater inflater;
    private final List<Wool> items;
    private Item ItemListener;

    public WoolAdapter(Context context, List<Wool> items, Item ItemListener) {
        this.items = items;
    ...
    @Override
    public WoolAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void
    onBindViewHolder(WoolAdapter.ViewHolder holder, int position) {
        Wool item = items.get(position);
